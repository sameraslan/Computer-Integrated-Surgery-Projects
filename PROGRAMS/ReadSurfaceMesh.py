...
def read_surfacemesh(file):
    ...
    # reads in vertices into (numVertices) xyz coordinates of vertices in CT coordinates
    ...
    triangle_vertex_coords = triangle_vertices[[0, 1, 2]]

    print(np.array(triangle_vertex_coords))
